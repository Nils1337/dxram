 ...
 */
public class CreateLocal extends AbstractOperation {
     ...
     */
    public CreateLocal(final Class<? extends AbstractDXRAMService> p_parentService, final BootComponent p_boot,
